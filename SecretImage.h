...
public:
    ...
    // Üst üçgen boyutunu hesaplayan fonksiyon
    static int calculate_upper_size(int width);
    // Alt üçgen boyutunu hesaplayan fonksiyon
    static int calculate_lower_size(int width);
